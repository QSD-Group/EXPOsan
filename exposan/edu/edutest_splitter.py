...
# Q_was = 200000                                 # sludge wastage flowrate [m3/d]
...
C1 = su.Splitter('C1', ins=O1-0, outs=[effluent, solid], split=0.95*(1-cmps.x))
# C1 = su.FlatBottomCircularClarifier('C1', ins=O1-0, outs=[effluent, ext_recycle, wastage],  
#                                     underflow=Q_ext, wastage=Q_was, surface_area=1500,
#                                     height=4, N_layer=10, feed_layer=5,                     
#                                     X_threshold=3000, v_max=474, v_max_practical=250,
#                                     rh=5.76e-4, rp=2.86e-3, fns=2.28e-3)

S1 = su.Splitter('S1', ins=C1-1, outs=[ext_recycle, wastage], split=0.98)
...
df = load_data(os.path.join(data_path, 'initial_conditions_asm1_.xlsx'), sheet='default')
...
#%%
# Q_was = 10, SRT= 67.76 d
# Q_was = 50, SRT= 13.55 d
# Q_was = 100, SRT=6.78 d
# Q_was = 200, SRT=3.39 d
# Q_was = 300, SRT=2.26 d
# Q_was = 385, SRT=1.77 d
# Q_was = 400, SRT=1.71 d
# Q_was = 500, SRT=1.37 d
# Q_was = 700, SRT=0.99 d                                
# Q_was = 1000, SRT=0.7 d
# Q_was = 2000, SRT=0.37 d
# Q_was = 5000, SRT=0.17 d
# Q_was = 6000, SRT=0.15 d
# Q_was = 15000, SRT=0.08 d
# Q_was = 20000, SRT=0.07 d
# Q_was = 40000, SRT=0.04 d

# Q_was = 100000, SRT=0.02 d
# Q_was = 150000, SRT=0.014 d

# Q_was = 200000, SRT=0.01 d
