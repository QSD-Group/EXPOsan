...
def get_CAPEX():
    return sys_PSA.installed_equipment_cost
...
def get_H2SO4_VOC():
    return H2SO4_Tank.ins[0].price*H2SO4_Tank.ins[0].F_mass*sys_PSA.operating_hours

@metric(name='H2_VOC',units='$/yr',element='TEA')
def get_H2_VOC():
    return RSP1.ins[0].price*RSP1.ins[0].F_mass*sys_PSA.operating_hours

@metric(name='CHG_catalyst_VOC',units='$/yr',element='TEA')
def get_CHG_catalyst_VOC():
    return CHG.ins[1].price*CHG.ins[1].F_mass*sys_PSA.operating_hours
...
def get_utility_VOC():
    return sys_PSA.utility_cost

@metric(name='HTL_utility_VOC',units='$/yr',element='TEA')
def get_HTL_utility_VOC():
    return (SluC.utility_cost+P1.utility_cost+H1.utility_cost+HTL.utility_cost)*sys_PSA.operating_hours

@metric(name='CHG_utility_VOC',units='$/yr',element='TEA')
def get_CHG_utility_VOC():
    return (CHG.utility_cost+F1.utility_cost)*sys_PSA.operating_hours
...
def get_HTL_utility_GWP():
    ...
    return table_other['Cooling [MJ]']/sys_PSA.get_cooling_duty()*(-a*sys_PSA.operating_hours)+\
           table_other['Electricity [kWh]']/(sys_PSA.get_electricity_consumption()-sys_PSA.get_electricity_production())*\
           (SluC.power_utility.consumption+P1.power_utility.consumption)*sys_PSA.operating_hours
...
def get_CHG_utility_GWP():
    ...
    return table_other['Cooling [MJ]']/sys_PSA.get_cooling_duty()*(-a*sys_PSA.operating_hours)+\
           table_other['Electricity [kWh]']/(sys_PSA.get_electricity_consumption()-sys_PSA.get_electricity_production())*\
           CHG.power_utility.consumption*sys_PSA.operating_hours
...
def get_HT_HC_utility_GWP():
    ...
    return table_other['Cooling [MJ]']/sys_PSA.get_cooling_duty()*(-a*sys_PSA.operating_hours)+\
           table_other['Electricity [kWh]']/(sys_PSA.get_electricity_consumption()-sys_PSA.get_electricity_production())*\
           (P2.power_utility.consumption+P3.power_utility.consumption)*sys_PSA.operating_hours
...
def get_CHP_utility_GWP():
    table_other = lca_diesel.get_impact_table('Other')['GlobalWarming [kg CO2-eq]']
    return table_other['Electricity [kWh]']/(sys_PSA.get_electricity_consumption()-sys_PSA.get_electricity_production())*\
           (-CHP.power_utility.production)*sys_PSA.operating_hours
