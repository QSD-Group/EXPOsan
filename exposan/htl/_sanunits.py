...
class HT(Reactor):
    ...
    def _run(self):
        ...
        ht_out.imass['H2'] = biocrude.imass['Biocrude']*\
                             self.hydrogen_rxned_to_biocrude*(self.hydrogen_excess - 1)
...
class HT_PSA(Reactor):
    ...
    def _run(self):
        ...
        if self.PSA_efficiency > 1:
            raise Exception('PSA efficiency cannot be larger than 1')
        
        hydrogen.imass['H2'] = biocrude.imass['Biocrude']*\
                               self.hydrogen_rxned_to_biocrude*(self.hydrogen_excess - (self.hydrogen_excess - 1)*self.PSA_efficiency)
        hydrogen.phase = 'g'
        ...
        ht_out.imass['H2'] = biocrude.imass['Biocrude']*\
                             self.hydrogen_rxned_to_biocrude*(self.hydrogen_excess - (self.hydrogen_excess - 1)*self.PSA_efficiency - 1)
    ...
    def _design(self):
        ...
        self.ins[1].phase = 'g'                       
        Design['Hydrogen_PSA'] = self.ins[1].F_vol*_m3perh_to_mmscfd*101325/self.PSA_pre
        ...
        Design['PSA'] = 0.5*Design['Weight']*Design['Number of reactors'] # assume stainless steel
        ...
        self.construction[0].quantity += Design['PSA']*_lb_to_kg
