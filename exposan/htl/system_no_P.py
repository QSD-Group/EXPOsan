...
def get_NaOH_VOC():
    return MemDis.ins[2].price*MemDis.ins[2].F_mass*sys_no_P.operating_hours

@metric(name='membrane_VOC',units='$/yr',element='TEA')
def get_membrane_VOC():
    return MemDis.ins[3].price*MemDis.ins[3].F_mass*sys_no_P.operating_hours
