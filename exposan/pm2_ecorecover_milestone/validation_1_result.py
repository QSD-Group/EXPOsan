...
T, I = EDV.batch_init(os.path.join(data_path, 'exo_vars_dynamic_influent_vali_1.xlsx'), 'linear')
...
SE = su.DynamicInfluent('SE', outs=[DYINF],
                        data_file=ospath.join(data_path, 'dynamic_influent_vali_1.tsv'))
# SE = su.DynamicInfluent('SE', outs=[DYINF],
...
batch_init(ospath.join(data_path, 'initial_conditions_pm2_dynamic_influent_vali_1.xlsx'), 'default')
