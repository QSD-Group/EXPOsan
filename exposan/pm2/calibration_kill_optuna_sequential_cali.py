...
def objective(trial):
    ...
    try:
        ...
        mdl._update_state(current_params, t_span=(0, 50), t_eval = np.arange(0, 51, 1), method='RK23', state_reset_hook='reset_cache', print_t=False, events=time_track)
...
if __name__ == '__main__':
    ...
    df.to_excel(ospath.join(results_path, 'conti_optuna_kill_sequential.xlsx'))
