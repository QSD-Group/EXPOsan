...
from exposan.mechanistic import data_path
...
def create_system(
    ...
    if aeration_processes:
        ...
        aer1 = pc.DiffusedAeration('aer1', DO_ID, DOsat=8.0, V=V_ae, Q_air=764.3221021)                  #  need to think about KLa
        aer2 = pc.DiffusedAeration('aer2', DO_ID, DOsat=8.0, V=V_ae, Q_air=1617.996689)                  #  need to think about KLa
        aer3 = pc.DiffusedAeration('aer3', DO_ID, DOsat=8.0, V=V_ae, Q_air=578.9891202)                  #  need to think about KLa
