...
NaClO = Component.from_chemical('NaClO', tmo.Chemical('NaClO'), 
                                formula='NaClO',
                  phase='l', particle_size = 'Soluble', 
               degradability = 'Undegradable', organic=False)
...
Polyethylene = Component('Polyethylene',
                                   formula='C2H4',
                                   phase='s', particle_size='Particulate',
...
AgNp = Component.from_chemical('AgNp', tmo.Chemical('Ag'),
...
cmps = Components((NH3, NonNH3, P, K, Mg, Ca, H2O, OtherSS, N2O, CH4, O2, N2,
                   CO2, P4O10, NaClO, Ecoli, Tissue, WoodAsh, Struvite, HAP, Polyethylene, AgNp))
for i in cmps:
