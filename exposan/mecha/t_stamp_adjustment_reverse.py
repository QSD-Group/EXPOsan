...
do['Q_inf'] = np.interp(t_intp, t_online, online['Q_inf'])

# do['X_BH'] = np.interp(t_intp, t_online, online['X_BH'])  # evaluation only
...
plot_raw_vs_intp(t_online, online['Q_inf'], do['t_stamp'], do['Q_inf'])

do.to_excel('results/train_val_test_DO_interpolated_v2.xlsx')
