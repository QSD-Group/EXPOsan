...
inf_dyn = pd.read_csv(os.path.join(data_path, 'training_dynamic_influent_.csv'), sep='\t', skiprows=[1])
...
out = wrapper.evaluate_blockdiagram_julia(0, 100, np.arange(0, 100, 1/24))
out.to_excel('results/peepypoo_result.xlsx')
