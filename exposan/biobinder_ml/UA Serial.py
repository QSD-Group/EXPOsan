# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 12:25:08 2026
...
def main():
        ...
        for cfg in CONFIGS:
            ...
            if RUN_MODE == "full":
                ...
                for t in tasks:
                    ...
                    if done % 100 == 0:
                        pd.DataFrame(results).sort_values("Sample_ID").to_excel(meta_path, index=False)
                        print(f"💾 Autosaved progress at sample {sid}")
    ...
    #                 OUTPUT_DIR,
    #                 f"SHAP3_SURROGATE_B_{feedstock_id}_{config_name}_{target}_prefer-{PREFER}_{timestamp}.xlsx"
    #             )
