...
simulation_file = os.path.join(output_dir, "simulation_results_{timestamp}.xlsx")
simulation_df.to_excel(simulation_file, index=False)

# # Save optimization results to Excel
# optimization_df = pd.DataFrame(optimization_results)
# optimization_file = os.path.join(output_dir, "optimization_results_{timestamp}.xlsx")
