...
pm2 = pc.PM2(arr_e=3455, K_P=15.65, f_CH_max=3.75, exponent=9.99, q_CH=1.69, q_LI=40.92, V_NH=0.131, V_P=0.504,
              ...
              Y_LI_NR_HET_GLU=1.620, Y_LI_ND_HET_GLU=1.046, Y_X_ALG_HET_GLU=0.317) # optuna, seed333, n5000, step100
...
def run(t, t_step, method=None, print_t=False, **kwargs):
    if method:
        sys.simulate(state_reset_hook='reset_cache',
                      ...
                      # rtol=1e-2,
                      # atol=1e-3,
                      export_state_to=f'results/sol_{t}d_{method}_batch_may_kinetic_cali_optuna_seed333_n5000.xlsx',
                      print_t=print_t,
                      **kwargs)
    else:
        sys.simulate(state_reset_hook='reset_cache',
