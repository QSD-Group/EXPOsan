...
pm2 = pc.PM2(arr_e=7054, K_P=3.34, f_CH_max=0.47, exponent=6.93, q_CH=3.28, q_LI=27.86, V_NH=0.157, V_P=0.746,
...
def run(t, t_step, method=None, print_t=False, **kwargs):
    if method:
        sys.simulate(state_reset_hook='reset_cache',
                      ...
                      # rtol=1e-2,
                      # atol=1e-3,
                      export_state_to=f'results/sol_{t}d_{method}_batch_may_unit_cali_optuna_10000.xlsx',
                      print_t=print_t,
                      **kwargs)
    else:
        sys.simulate(state_reset_hook='reset_cache',
