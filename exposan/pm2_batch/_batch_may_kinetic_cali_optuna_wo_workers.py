...
pm2 = pc.PM2(arr_e=1130.64758845091, K_P=10.9187771670637, f_CH_max=4.49330213104013, exponent=5.29487039643295, q_CH=1.83088852706361, q_LI=39.285152428859, V_NH=0.124307725701855, V_P=0.553320590407534,
...
# pm2 = pc.PM2(arr_e=9981, K_P=0.3699, f_CH_max=9.942, exponent=1.039, q_CH=9.948, q_LI=1.707, V_NH=0.9943, V_P=0.01481,
#               a_c=0.049, I_n=1500, arr_a=1.8e10, beta_1=2.90,
#               beta_2=3.50, b_reactor=0.03, I_opt=2000, k_gamma=1e-5,
#               K_N=0.1, K_A=6.3, K_F=6.3, rho=1.186, K_STO=1.566,
#               f_LI_max=3.249, m_ATP=10,
...
def run(t, t_step, method=None, print_t=False, **kwargs):
    if method:
        sys.simulate(state_reset_hook='reset_cache',
                      ...
                      # rtol=1e-2,
                      # atol=1e-3,
                      export_state_to=f'results/sol_{t}d_{method}_batch_may_kinetic_cali_optuna_wo_parallelization.xlsx',
                      print_t=print_t,
                      **kwargs)
    else:
        sys.simulate(state_reset_hook='reset_cache',
