...
for system in ('A', 'B', 'C'):
    ...
    input_excel_name = f'Bwaise_sanitation_inputs_baseline{system}.xlsx'
    ...
    writer = pd.ExcelWriter(f'Bwaise_sanitation_outputs_baseline{system}.xlsx', engine='xlsxwriter')
