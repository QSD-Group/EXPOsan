...
# # # # ------------------------------------------------------------------------------------------------------------------
    ...
    fig, axis = fs.effluent.scope.plot_time_series(('S_A', 'S_F', 'X_S', 'S_NH4', 'S_NO', 'X_I', 'S_I', 'S_N2')) 
    fig
...
#     samples = B1_model.sample(N=10000, rule='L')
...
#     import pandas as pd
#     file_path = "/Users/saumitrarai/Desktop/Research/MS_research/metro/results/B1_comprehensive_uncertainty_analysis.xlsx"  
