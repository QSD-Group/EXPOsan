...
def create_system(flowsheet=None, inf_kwargs={}, asm_kwargs={}, init_conds={}, lifetime=100, discount_rate=0.1,
    ...
    PC = su.PrimaryClarifier('PC', ins=[dom_ww, ind_ww, eff_GT, eff_MT, eff_DU],
...
# # -----------------------------------------------------------------------------
    ...
    # dist_N2O_EF_st = shape.Triangle(lower= 0.000044, midpoint=0.0040, upper=0.0172 # in kg CH4/kg CO2 r
...
#     disposed_sludge = (fs.sludge_DU, )
    ...
    B1_model.table.iloc[:,-8:] = all_outputs
    
    B1_model.table

    import pandas as pd
    file_path = "/Users/saumitrarai/Desktop/Research/MS_research/metro/results/B1_N2O_CO2_simulations.xlsx"  
    sheet_name = "bm2"  # Change this to your desired sheet name
