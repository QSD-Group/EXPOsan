...
pm2 = pc.PM2(arr_e=7141, K_P=5.92, f_CH_max=0.83, exponent=7.09, q_CH=3.52, q_LI=32.65, V_NH=0.134, V_P=0.754,
              ...
              Y_LI_NR_HET_GLU=1.620, Y_LI_ND_HET_GLU=1.046, Y_X_ALG_HET_GLU=0.317) # optuna, seed777, n5000, step100

# pm2 = pc.PM2(arr_e=7049, K_P=0.0185, f_CH_max=0.448, exponent=7.52, q_CH=4.42, q_LI=30.80, V_NH=0.209, V_P=0.629,
#               a_c=0.049, I_n=1500, arr_a=1.8e10, beta_1=2.90,
#               beta_2=3.50, b_reactor=0.03, I_opt=2000, k_gamma=1e-5,
#               K_N=0.1, K_A=6.3, K_F=6.3, rho=1.186, K_STO=1.566,
#               f_LI_max=3.249, m_ATP=10,
...
#               Y_LI_NR_HET_ACE=1.105, Y_LI_ND_HET_ACE=0.713, Y_X_ALG_HET_ACE=0.216,
#               Y_ATP_HET_GLU=58.114, Y_CH_NR_HET_GLU=0.917, Y_CH_ND_HET_GLU=0.880,
#               Y_LI_NR_HET_GLU=1.620, Y_LI_ND_HET_GLU=1.046, Y_X_ALG_HET_GLU=0.317) # n10000
...
def run(t, t_step, method=None, print_t=False, **kwargs):
    if method:
        sys.simulate(state_reset_hook='reset_cache',
                      ...
                      # rtol=1e-2,
                      # atol=1e-3,
                      export_state_to=f'results/sol_{t}d_{method}_batch_may_unit_cali_optuna_seed777_n5000.xlsx',
                      print_t=print_t,
                      **kwargs)
    else:
        sys.simulate(state_reset_hook='reset_cache',
