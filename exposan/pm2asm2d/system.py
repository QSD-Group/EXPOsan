...
T_nov, I_nov = EDV.batch_init(os.path.join(data_path, 'exo_vars_batch_november.xlsx'), 'linear')
...
def create_system(flowsheet=None, pm2asm2d_kwargs={}, init_conds={}, kind=''):
    ...
    PBR = su.BatchExperiment('PBR', model=pm2asm2d, exogenous_vars=(T_nov, I_nov))
