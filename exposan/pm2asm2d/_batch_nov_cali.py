...
pm2asm2d = pc.PM2ASM2d(a_c=0.0140264685430579, arr_e=6101.68141831652, K_P=4.13107619555845, K_A=2.77768066194642,
...
def run(t, t_step, method=None, print_t=True, **kwargs):
    if method:
        sys.simulate(state_reset_hook='reset_cache',
                      ...
                      # rtol=1e-2,
                      # atol=1e-3,
                      export_state_to=f'results/sol_{t}d_{method}_batch_nov_cali_optuna_low_vno.xlsx',
