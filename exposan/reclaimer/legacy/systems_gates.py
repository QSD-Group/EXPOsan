...
def get_summarizing_functions():
    ...
    # ADD get_annual_H_ecosystems etc.
    #lca, ppl: lca.total_impacts['H_Ecosystems'] / lca.lifetime / ppl
    # comment out breakdown summarizing functions so it doesn't take time.
