...
def add_metrics(system):
    ...
    metrics.extend([
        ...
        # ADD THESE IN FOR EACH RECIPE ITEM
        # Metric('Resource_Depletion', lambda: func['get_annual_GWP'](lca, ppl), 'points', cat),

        # ADD N, P, K RECOVERY METRICS similar to NEWgen and OP
        # lambda: 0
        ])
