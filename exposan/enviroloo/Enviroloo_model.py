...
CT_data = load_el_su_data('_EL_CT.tsv.txt')
PC_data = load_el_su_data('_EL_PC.tsv.txt')
AnoxicTank_data = load_el_su_data('_EL_Anoxic.tsv.txt')
AerobicTank_data = load_el_su_data('_EL_Aerobic.tsv.txt')
MembTank_data = load_el_su_data('_EL_MBR.tsv.txt')
Blower = load_el_su_data('_EL_blower.tsv')
ClearWaterTank_data = load_el_su_data('_EL_CWT.tsv.txt')
...
photovoltaic_wind_data = load_el_su_data('_EL_photovoltaic_wind.txt')
