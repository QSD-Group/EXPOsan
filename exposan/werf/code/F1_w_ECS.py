...
#     samples = F1_model.sample(N=100, rule='L')
#     F1_model.load_samples(samples)
...
#         for p, v in zip(F1_model.parameters, sample):
#             p.setter(v)
    
#         out = [m() for m in F1_model.metrics]
#         all_outputs.append(out)
    
#     F1_model.table.iloc[:,-14:] = all_outputs
...
#     if ESAP_inc == 'included':
#         sheet_name = "F1_with_ECS"  
#     elif ESAP_inc == 'not_included':
#         sheet_name = "F1" 
        
#     with pd.ExcelWriter(file_path, engine='openpyxl', mode='a') as writer:
#         F1_model.table.to_excel(writer, sheet_name=sheet_name)
    
#     fig, ax = qs.stats.plot_uncertainties(F1_model, x_axis=F1_model.metrics[0], y_axis=F1_model.metrics[1],
#                                       kind='kde-kde', center_kws={'fill': True})
#     fig

#     r_df, p_df = qs.stats.get_correlations(F1_model, kind='Spearman')
#     print(r_df, p_df)
