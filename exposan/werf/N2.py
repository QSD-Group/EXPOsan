...
def create_n2_system(flowsheet=None, default_init_conds=True):
    flowsheet = flowsheet or qs.Flowsheet('N2')
    ...
    carb = qs.WasteStream('carbon', T=Temp, units='kg/hr', S_A=50)
    ...
    HD = su.HydraulicDelay('HD', ins=MX-0, outs=3-ASR)
    ...
    sys.set_dynamic_tracker(S1-1, AED)
