...
def create_g1_system(flowsheet=None, default_init_conds=True):
    ...
    A1 = su.CSTR('A1', ins=[carb, 'RAS'], V_max=V_tot*fr_V[0], **anae_kwargs)
    A2 = su.CSTR('A2', [A1-0, S1-0], V_max=V_tot*fr_V[1], **anae_kwargs)
    A3 = su.CSTR('A3', [A2-0, 'intr', S1-1], V_max=V_tot*fr_V[2], **anox_kwargs)
    A4 = su.CSTR('A4', A3-0, V_max=V_tot*fr_V[3], **anox_kwargs)
    O1 = su.CSTR('O1', A4-0, V_max=V_tot*fr_V[4], **ae_kwargs)
